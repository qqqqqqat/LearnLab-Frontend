...
<template>
    <div id="hs-slide-down-animation-modal" ref="modalElem"
        ...
        <div
            ...
            <div class="pointer-events-auto flex flex-col rounded-md border bg-white shadow-sm">
                ...
                <div class="flex flex-col overflow-y-auto">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-0.5 flex justify-center space-x-6">
                            <button type="button" :class="activeTab === 0
                            ...
                            <button type="button" :class="activeTab === 1
                                    ? 'border-b-2 border-blue-600 font-semibold text-blue-600'
                                    : 'border-transparent text-gray-500'
                                "
                    ...
                    <div
                        ...
                        <div class="relative h-fit w-full grow overflow-x-hidden">
                            <TransitionGroup name="fade">
                                <form v-show="activeTab === 0" key="login1" class="flex flex-col gap-y-8 p-8"
                                    @submit.prevent="">
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <svg class="size-4 flex-shrink-0 text-gray-500"
                                    ...
                                    <div class="flex items-center justify-center gap-x-2 px-4 py-3 md:justify-end">
                                        <button type="button" :disabled="!(email && password)"
                                ...
                                <form v-show="activeTab === 1" key="regis1" class="flex flex-col gap-y-8 p-8"
                                    @submit.prevent="">
                                    <div class="hs-dropdown relative">
                                        <button id="hs-dropdown-position" type="button"
                                            ...
                                            {{ position.title }}
                                            <svg class="size-4 transition duration-150 ease-in-out hs-dropdown-open:rotate-180"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round">
                                                <path d="m6 9 6 6 6-6" />
                                        ...
                                        <div class="hs-dropdown-menu duration z-[100] mt-2 hidden w-64 rounded-lg bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] before:absolute before:-top-4 before:start-0 before:h-4 before:w-full after:absolute after:-bottom-4 after:start-0 after:h-4 after:w-full hs-dropdown-open:opacity-100"
                                    ...
                                    <div class="hs-dropdown relative">
                                        <button id="hs-dropdown-gender" type="button"
                                            class="hs-dropdown-toggle inline-flex w-full items-center justify-between gap-x-2 rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50">
                                            {{ gender.title }}
                                            <svg class="size-4 transition duration-150 ease-in-out hs-dropdown-open:rotate-180"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="relative">
                                        <input v-model.lazy="surname" type="text"
                                            class="peer block w-full rounded-lg border-transparent bg-gray-100 px-4 py-3 ps-11 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
                                            placeholder="นามสกุล">
                                        <div
                                            class="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-4 peer-disabled:pointer-events-none peer-disabled:opacity-50">
                                    ...
                                    <div class="relative">
                                        <input v-model="regis_email" type="email"
                                            class="peer block w-full rounded-lg border-transparent bg-gray-100 px-4 py-3 ps-11 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
                                            placeholder="อีเมล์">
                                        <div
                                            class="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-4 peer-disabled:pointer-events-none peer-disabled:opacity-50">
                                    ...
                                    <div class="relative">
                                        <input v-model="regis_passw" type="password"
                                            class="peer block w-full rounded-lg border-transparent bg-gray-100 px-4 py-3 ps-11 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
                                    ...
                                    <div class="relative">
                                        <input v-model="regis_passw_conf" type="password"
                                            class="peer block w-full rounded-lg border-transparent bg-gray-100 px-4 py-3 ps-11 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50"
                                    ...
                                    <div>
                                        ...
                                        <input id="small-file-input" type="file" accept="image/*"
