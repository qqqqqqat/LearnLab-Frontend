    ...
    <div class="flex flex-col gap-4 pb-16 px-4">
      <div class="flex gap-x-4 relative">
        ...
        <div class="flex items-center">
          Courses
          <span class="material-icons-outlined">chevron_right</span> View
      ...
      <div class="flex relative">
        ...
        <div
          v-if="!crs_pending"
          class="absolute flex flex-col gap-2 left-5 bottom-5"
        >
          <span class="text-4xl font-bold text-white">{{
            crs_info?.c_name
          }}</span>
          <span
            class="bottom-0 text-sm font-light text-white h-auto max-h-10 overflow-auto"
          >
        ...
        <div
          v-else
          class="absolute w-full flex flex-col gap-2 left-5 bottom-5 animate-pulse"
        >
          <span class="text-4xl font-bold text-white">
            <h3
              class="h-8 bg-white rounded-full w-[200px]"
            ></h3>
          </span>
          <span
            class="bottom-0 text-sm font-light text-white max-h-10 w-full h-3 bg-white rounded-full"
            style="width: 90%"
          >
          </span>
        </div>
      ...
      <div class="flex md:flex-row flex-col gap-4">
        <nav
          class="flex flex-col border border-1 rounded-lg shadow-sm md:w-64 w-full"
        >
          <div
            @click="
              navigateTo({
            ...
            :class="
              route.path === '/courses/view'
                ...
                : 'hover:bg-blue-300/50 text-black'
            "
            class="nav-menu"
          >
          ...
          <div class="nav-menu">
            PHPSESSIONID: {{ sessionInfo }}
          </div>
          <div class="nav-menu" @click="fetchSessionID()">
            Fetch
          </div>
          <div class="nav-menu" @click="destroySession()">
            Destroy
          </div>
        </nav>
