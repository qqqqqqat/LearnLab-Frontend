...
import { $fetchBlobWithHeader } from '#imports';
...
// onUnmounted(() => {
//         if (avatarState.value?.u_avatar_blob_url)
//         URL.revokeObjectURL(avatarState.value?.u_avatar_blob_url)
//     })
        ...
        <div class="flex h-full w-full flex-col items-center gap-y-8">
            ...
            <div class="flex flex-col items-center gap-8 md:flex-row md:items-start">
                ...
                <div v-else class="h-64 w-64 rounded-md">
                    <img class="aspect-square h-64 w-64 rounded-md object-cover" :src="avatarState.u_avatar_blob_url">
                </div>
                <div
            ...
            <div class="relative w-72">
                ...
                <div
                    ...
                    <svg class="size-4 flex-shrink-0 text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div>
                ...
                <input id="small-file-input" type="file" accept="image/*" name="small-file-input"
            ...
            <button
                ...
                href="#" :disabled="regis_passw?.length < 3" @click="updateUser">
